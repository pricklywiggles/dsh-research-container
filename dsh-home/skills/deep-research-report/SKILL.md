...
description: Summarize /deep-research results into a markdown report - cover all fields from the collected JSON, skip uncertain values, with a table of contents. Use after /deep-research-run completed, or when the user invokes /deep-research-report.
---

# Deep Research Report - Summary Report (ported from research-report)
...
Find `*/outline.yaml` under /workspace, read topic and output_dir config.
...
Run `python3 {topic}/generate_report.py`
