...
10. **this rather than that** "I should look rathern than guess". Most of the time this can be fully removed, adds no value.
...
13. **Never use Em dash.** Avoid em dashes entirely. Use periods or commas only (no parentheses, no en dashes, no hyphen-as-dash substitutes). Em dashes are an AI tell, and reaching for parentheses instead just trades one tell for another. If a thought needs separation, end the sentence or use a comma.
...
### Unnecessary response verbosity

23. **Adding opinion that doesn't add value** "Yes, and it is a real problem", "Confirmed, and this is the real finding of the whole review.". Be succint, state the short reponse and don't add extra words.
24. **Assigning blame** "And that's my mistake". I already know, no need to say it.
